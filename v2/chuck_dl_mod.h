...
extern "C" {
typedef Chuck_Object * (* f_ctor)( void * ARGS );
typedef void (* f_dtor)( Chuck_Object * THIS );
typedef void (* f_mfun)( Chuck_Object * THIS, void * ARGS, Chuck_DL_Return * RETURN );
typedef void (* f_sfun)( void * ARGS, Chuck_DL_Return * RETURN );
}
