...
t_CKBOOL type_engine_scancheck_func_def( Chuck_Env * env, a_Func_Def func_def );
t_CKBOOL type_engine_scancheck_class_def( Chuck_Env * env, a_Class_Def class_def );
...
//-----------------------------------------------------------------------------
// name: type_engine_scancheck_class_def()
// desc: ...
//-----------------------------------------------------------------------------
t_CKBOOL type_engine_scancheck_class_def( Chuck_Env * env, a_Class_Def class_def )
{
...
//-----------------------------------------------------------------------------
// name: type_engine_scancheck_func_def()
// desc: ...
//-----------------------------------------------------------------------------
t_CKBOOL type_engine_scancheck_func_def( Chuck_Env * env, a_Func_Def f )
{
    Chuck_Type * type = NULL;
    Chuck_Value * value = NULL;
    Chuck_Func * func = NULL;
