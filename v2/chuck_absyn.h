...
a_Type_Decl new_type_decl( a_Id_List id, int ref, int pos );
...
a_Class_Def new_class_def( ae_Keyword class_decl, a_Id_List id, a_Class_Ext ext, a_Class_Body body, int pos );
...
a_Class_Def new_iface_def( ae_Keyword class_decl, a_Id_List id, a_Class_Ext ext, a_Class_Body body, int pos );
...
struct a_Exp_Decl_ { a_Type_Decl type; a_Var_Decl_List var_decl_list; int is_static; t_CKTYPE ck_type; 
                     int linepos; a_Exp self; };
