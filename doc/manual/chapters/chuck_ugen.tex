...
\control
\begin{chuckitemize}
\item {\bf .data1} (int, READ/WRITE) {\it first byte of data}
\item {\bf .data2} (int, READ/WRITE) {\it second byte of data}
\item {\bf .data3} (int, READ/WRITE) {\it third byte of data}
\end{chuckitemize}
(see MIDI tutorial)
}
